    ...
    <section className="max-w-6xl mx-auto px-4 md:px-6 py-8">
      ...
      <div className="mb-4 relative max-w-md">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2 rounded-lg border border-[color:var(--border)] bg-[color:var(--surface)] text-sm outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ring)]"
        />
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {items.map((g, i) => (
            ...
            >
              ...
              <p className="text-sm text-[color:var(--muted-foreground)] mt-2 line-clamp-4">
                {g.definition}
              </p>
